...
@Model.register("tne_coupled_model2")
class TNECoupledModel(Model):
    ...
    def __init__(
        ...
        self._conv_layer = TimeDistributed(conv_layer)
    ...
    def forward(
        ...
        conv_vec = self._conv_layer(mat.unsqueeze(0),mask=None)

        preposition_scores = self._preposition_scorer(conv_vec).squeeze(0)
